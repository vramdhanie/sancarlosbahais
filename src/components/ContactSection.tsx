  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-b from-blue-600 to-blue-800 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        {/* Desktop Layout: Contact info on left, form on right */}
        <div className="hidden lg:grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Community Building Registration</h3>
            <div 
              style={{width:'100%',height:'500px'}} 
              data-fillout-id="oEgP7bHF4Hus" 
        ...
        {/* Mobile Layout: Contact info stacked, form underneath */}
        <div className="lg:hidden space-y-8">
          ...
          {/* Mobile Form */}
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Community Building Registration Form</h3>
            <div 
              style={{width:'100%',height:'500px'}} 
              data-fillout-id="oEgP7bHF4Hus" 
              data-fillout-embed-type="standard" 
